...
def build_ceutrack(cfg, training=True):
    ...
    # pretrained_path = "/wangx/DATA/Code/chenqiang/Attack/CEUTrack/pretrained_models/mae_pretrain_vit_base.pth"
    # if cfg.MODEL.PRETRAIN_FILE and ('CEUTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    #     pretrained = os.path.join(pretrained_path, cfg.MODEL.PRETRAIN_FILE)
    # else:
    #     pretrained = ''
    pretrained = "/wangx/DATA/Code/chenqiang/Attack/CEUTrack/pretrained_models/mae_pretrain_vit_base.pth"
